...
public final class ItemChatMessageBinding implements ViewBinding {
  ...
  private ItemChatMessageBinding(@NonNull LinearLayout rootView, @NonNull TextView tvChatMessage) {
  ...
  public static ItemChatMessageBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.tvChatMessage;
      TextView tvChatMessage = ViewBindings.findChildViewById(rootView, id);
      if (tvChatMessage == null) {
        break missingId;
      }

      return new ItemChatMessageBinding((LinearLayout) rootView, tvChatMessage);
    }
